...
class ColorConstants{
  ...
  static Color bigStoneColor = Color(0xFF192841);
  static Color paleSkyColor = Color(0xFF656F80);
  static Color alto = Color(0xFFD4D4D4);
  static Color sunshadeColor=Color(0xFFFFAB2D);
  static Color orangeColor =Color(0xFFFF7A00);
  static Color dustyGrayColor =Color(0xFF9B9B9B);
  ...
  static Color HH = Color(0xFF222222);
}