...
import 'package:design_premium_account/modules/profile/add_hobbies.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: (){
                Navigator.of(context).push(MaterialPageRoute(builder: (context)=> const AddHobbiesgfeuy()));
              },
              child: Container(
