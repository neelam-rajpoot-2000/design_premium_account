...
class AddHobbiesBadmintonOneHobby extends StatefulWidget {
  const AddHobbiesBadmintonOneHobby({Key? key}) : super(key: key);

  @override
  State<AddHobbiesBadmintonOneHobby> createState() => _AddHobbiesBadmintonOneHobbyState();
}

class _AddHobbiesBadmintonOneHobbyState extends State<AddHobbiesBadmintonOneHobby> {
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                    context,
                    RouteGenerator.generateRoute(
                        const RouteSettings(name: '/addHobbiesSurfing')));
              },
              child: Container(
                width: double.infinity,
                padding: const EdgeInsets.symmetric(vertical: 17),
