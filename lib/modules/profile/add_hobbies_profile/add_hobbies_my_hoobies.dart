...
class AddHobbiesMyHobbies extends StatefulWidget {
  const AddHobbiesMyHobbies({Key? key}) : super(key: key);

  @override
  State<AddHobbiesMyHobbies> createState() => _AddHobbiesMyHobbiesState();
}

class _AddHobbiesMyHobbiesState extends State<AddHobbiesMyHobbies> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: Padding(
          padding:
              const EdgeInsets.symmetric(vertical: 43.07, horizontal: 18.06),
          child: Column(
